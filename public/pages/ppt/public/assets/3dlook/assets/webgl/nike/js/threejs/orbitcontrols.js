...
THREE.OrbitControls = function ( object, domElement ) {
  ...
  this.switchMomentumOn = function(){
    momentumOn = true;
  }

  this.switchMomentumOff = function(){
    momentumOn = false;
  }
  ...
  this.zoomCamera = function(){
    ...
    var factor = 1.0 - _zoomStart//  * this.userZoomSpeed;
    scale *= factor;
    
    //this tends to 0
    _zoomStart -= _zoomStart * this.zoomDampingFactor;
