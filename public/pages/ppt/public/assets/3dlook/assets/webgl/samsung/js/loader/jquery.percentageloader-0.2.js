    ...
    window.PercentageLoader = function(el, params) {
      var settings, canvas, percentageText, valueText, items, i, item, selectors, s, ctx, progress,
        ...
        * (but we leave a little room so the borders aren't truncated) */
        ...
        /* Bottom left angle */
        startAngle =  1.58 //0.9707963267949 //0//2.1707963267949;
        /* Bottom right angle */
        endAngle = 1.58+ (Math.PI * 2.0);
       // 0.9707963267949 + (Math.PI * 2.0);
          ...
          ctx.stroke();
           ...
           ctx.stroke();
            ...
            (function () {
                ...
                percentageText.style.top = ((settings.height / 2) - (fontSize / 2)).toString() - 3 + 'px';
                percentageText.style.color = '#666666';
               ...
               // percentageText.style.textShadow = '0 1px 1px #FFFFFF';
                ...
                if( progress == "1" && firstRun == true ){
                     percentageText.innerHTML = "1%";

                }else if( firstRun == false ){
                     percentageText.innerHTML = string;
                }
                var prog2 = (progress * 100.0).toFixed(0)
                if( prog2 > .05 ){
                    firstRun = false;
                }
